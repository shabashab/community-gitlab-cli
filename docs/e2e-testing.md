...
| `mr` | mr-discussion-reactions | react/unreact + verified no-ops, colon-form emoji, view reactions column, `--reactions` aggregation, `note_not_in_discussion` / `invalid_note_id` / `invalid_emoji_name` |
