...
- `internal/cli/mr.go`: `mr` command suite (`list`, `view`, `create`, `update`, and `!<iid>` dispatch), `--fields` parsing, and merge request run functions.
